...
#        import pdb; pdb.set_trace()
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[2]/div[2]/input").clear()
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[2]/div[2]/input").send_keys("90")
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[2]/div[3]/input").clear()
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[2]/div[3]/input").send_keys("8")
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[3]/div[2]/input").clear()
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[3]/div[2]/input").send_keys("100")
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[3]/div[3]/input").clear()
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[3]/div[3]/input").send_keys("9")
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[4]/div[2]/input").clear()
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[4]/div[2]/input").send_keys("110")
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[4]/div[3]/input").clear()
        driver.find_element_by_xpath("//div[@id='collapse-barbell-bench-press']/div/div[4]/div[3]/input").send_keys("10")
