...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Client.share_gym_sessions'
        db.add_column(u'base_client', 'share_gym_sessions',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Client.share_checkins'
        db.add_column(u'base_client', 'share_checkins',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Client.share_gym_sessions'
        db.delete_column(u'base_client', 'share_gym_sessions')

        # Deleting field 'Client.share_checkins'
        db.delete_column(u'base_client', 'share_checkins')
    ...
    models = {
        ...
        u'base.client': {
            ...
            'share_checkins': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'share_gym_sessions': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
