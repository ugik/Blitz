...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blitz.price'
        db.alter_column(u'base_blitz', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'BlitzInvitation.price'
        db.alter_column(u'base_blitzinvitation', 'price', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Blitz.price'
        db.alter_column(u'base_blitz', 'price', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'BlitzInvitation.price'
        db.alter_column(u'base_blitzinvitation', 'price', self.gf('django.db.models.fields.IntegerField')())
