...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlitzInvitation.free'
        db.add_column(u'base_blitzinvitation', 'free',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'BlitzInvitation.price'
        db.add_column(u'base_blitzinvitation', 'price',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'BlitzInvitation.workout_plan'
        db.add_column(u'base_blitzinvitation', 'workout_plan',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workouts.WorkoutPlan'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlitzInvitation.free'
        db.delete_column(u'base_blitzinvitation', 'free')

        # Deleting field 'BlitzInvitation.price'
        db.delete_column(u'base_blitzinvitation', 'price')

        # Deleting field 'BlitzInvitation.workout_plan'
        db.delete_column(u'base_blitzinvitation', 'workout_plan_id')
