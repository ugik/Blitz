...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CheckInLike'
        db.create_table(u'base_checkinlike', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('checkin', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.CheckIn'], null=True, blank=True)),
            ('date_and_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal(u'base', ['CheckInLike'])

        # Adding field 'Comment.checkin'
        db.add_column(u'base_comment', 'checkin',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkincomments', null=True, to=orm['base.CheckIn']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CheckInLike'
        db.delete_table(u'base_checkinlike')

        # Deleting field 'Comment.checkin'
        db.delete_column(u'base_comment', 'checkin_id')
