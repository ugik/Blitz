...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Heading.heading_id'
        db.delete_column(u'base_heading', 'heading_id')

        # Deleting field 'Heading.short_name'
        db.delete_column(u'base_heading', 'short_name')

        # Adding field 'Heading.location'
        db.add_column(u'base_heading', 'location',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Heading.saying'
        db.add_column(u'base_heading', 'saying',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=150, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Heading.author'
        db.add_column(u'base_heading', 'author',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Heading.heading_id'
        db.add_column(u'base_heading', 'heading_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Heading.short_name'
        db.add_column(u'base_heading', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Heading.location'
        db.delete_column(u'base_heading', 'location')

        # Deleting field 'Heading.saying'
        db.delete_column(u'base_heading', 'saying')

        # Deleting field 'Heading.author'
        db.delete_column(u'base_heading', 'author')
