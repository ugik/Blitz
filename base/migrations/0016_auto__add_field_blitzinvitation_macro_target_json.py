...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlitzInvitation.macro_target_json'
        db.add_column(u'base_blitzinvitation', 'macro_target_json',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlitzInvitation.macro_target_json'
        db.delete_column(u'base_blitzinvitation', 'macro_target_json')
