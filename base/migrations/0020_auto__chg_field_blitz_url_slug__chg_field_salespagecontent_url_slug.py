...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Blitz.url_slug'
        db.alter_column(u'base_blitz', 'url_slug', self.gf('django.db.models.fields.SlugField')(max_length=50))

        # Changing field 'SalesPageContent.url_slug'
        db.alter_column(u'base_salespagecontent', 'url_slug', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Blitz.url_slug'
        db.alter_column(u'base_blitz', 'url_slug', self.gf('django.db.models.fields.SlugField')(max_length=25))

        # Changing field 'SalesPageContent.url_slug'
        db.alter_column(u'base_salespagecontent', 'url_slug', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))
