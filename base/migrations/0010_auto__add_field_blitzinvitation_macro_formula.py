...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlitzInvitation.macro_formula'
        db.add_column(u'base_blitzinvitation', 'macro_formula',
                      self.gf('django.db.models.fields.CharField')(default='DEFAULT', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlitzInvitation.macro_formula'
        db.delete_column(u'base_blitzinvitation', 'macro_formula')
