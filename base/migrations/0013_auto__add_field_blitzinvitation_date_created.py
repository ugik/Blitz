...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BlitzInvitation.date_created'
        db.add_column(u'base_blitzinvitation', 'date_created',
                      self.gf('django.db.models.fields.DateField')(default=datetime.date.today),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BlitzInvitation.date_created'
        db.delete_column(u'base_blitzinvitation', 'date_created')
