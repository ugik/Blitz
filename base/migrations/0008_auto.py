...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'TrainerAlert', fields ['date_created']
        db.create_index(u'base_traineralert', ['date_created'])

        # Adding index on 'MacroDay', fields ['day']
        db.create_index(u'base_macroday', ['day'])

        # Adding index on 'FeedItem', fields ['pub_date']
        db.create_index(u'base_feeditem', ['pub_date'])

        # Adding index on 'CheckIn', fields ['date_created']
        db.create_index(u'base_checkin', ['date_created'])

        # Adding index on 'GymSession', fields ['date_of_session']
        db.create_index(u'base_gymsession', ['date_of_session'])


    def backwards(self, orm):
        # Removing index on 'GymSession', fields ['date_of_session']
        db.delete_index(u'base_gymsession', ['date_of_session'])

        # Removing index on 'CheckIn', fields ['date_created']
        db.delete_index(u'base_checkin', ['date_created'])

        # Removing index on 'FeedItem', fields ['pub_date']
        db.delete_index(u'base_feeditem', ['pub_date'])

        # Removing index on 'MacroDay', fields ['day']
        db.delete_index(u'base_macroday', ['day'])

        # Removing index on 'TrainerAlert', fields ['date_created']
        db.delete_index(u'base_traineralert', ['date_created'])
