...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Scout'
        db.create_table(u'base_scout', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(default='', max_length=50)),
            ('url_slug', self.gf('django.db.models.fields.CharField')(default='', max_length=5)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True, blank=True)),
            ('desc', self.gf('django.db.models.fields.CharField')(default='', max_length=50, null=True, blank=True)),
        ))
        db.send_create_signal(u'base', ['Scout'])

        # Adding field 'Trainer.referral'
        db.add_column(u'base_trainer', 'referral',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Scout'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Scout'
        db.delete_table(u'base_scout')

        # Deleting field 'Trainer.referral'
        db.delete_column(u'base_trainer', 'referral_id')
