...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Comment', fields ['date_and_time']
        db.create_index(u'base_comment', ['date_and_time'])


    def backwards(self, orm):
        # Removing index on 'Comment', fields ['date_and_time']
        db.delete_index(u'base_comment', ['date_and_time'])
