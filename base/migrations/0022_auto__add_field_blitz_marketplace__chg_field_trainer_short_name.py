...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blitz.marketplace'
        db.add_column(u'base_blitz', 'marketplace',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'Trainer.short_name'
        db.alter_column(u'base_trainer', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=30))

    def backwards(self, orm):
        # Deleting field 'Blitz.marketplace'
        db.delete_column(u'base_blitz', 'marketplace')


        # Changing field 'Trainer.short_name'
        db.alter_column(u'base_trainer', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=10))
