...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlitzInvitation.blitz'
        db.alter_column(u'base_blitzinvitation', 'blitz_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Blitz'], null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'BlitzInvitation.blitz'
        raise RuntimeError("Cannot reverse this migration. 'BlitzInvitation.blitz' and its values cannot be restored.")
