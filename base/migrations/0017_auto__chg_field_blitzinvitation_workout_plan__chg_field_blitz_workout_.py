...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlitzInvitation.workout_plan'
        db.alter_column(u'base_blitzinvitation', 'workout_plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workouts.WorkoutPlan'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Blitz.workout_plan'
        db.alter_column(u'base_blitz', 'workout_plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workouts.WorkoutPlan'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):

        # Changing field 'BlitzInvitation.workout_plan'
        db.alter_column(u'base_blitzinvitation', 'workout_plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workouts.WorkoutPlan'], null=True))

        # Changing field 'Blitz.workout_plan'
        db.alter_column(u'base_blitz', 'workout_plan_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['workouts.WorkoutPlan'], null=True))
    ...
    models = {
        ...
        u'base.blitz': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'macro_strategy': ('django.db.models.fields.CharField', [], {'default': "'DEFAULT'", 'max_length': '1'}),
