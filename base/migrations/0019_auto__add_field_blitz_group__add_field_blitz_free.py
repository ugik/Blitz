...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Blitz.group'
        db.add_column(u'base_blitz', 'group',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Blitz.free'
        db.add_column(u'base_blitz', 'free',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Blitz.group'
        db.delete_column(u'base_blitz', 'group')

        # Deleting field 'Blitz.free'
        db.delete_column(u'base_blitz', 'free')
