...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'base_blitz', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Blitz.price'
        raise RuntimeError("Cannot reverse this migration. 'Blitz.price' and its values cannot be restored.")
