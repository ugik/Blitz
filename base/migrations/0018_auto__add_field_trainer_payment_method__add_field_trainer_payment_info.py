...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Trainer.payment_method'
        db.add_column(u'base_trainer', 'payment_method',
                      self.gf('django.db.models.fields.CharField')(default='D', max_length=1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Trainer.payment_info'
        db.add_column(u'base_trainer', 'payment_info',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Trainer.payment_method'
        db.delete_column(u'base_trainer', 'payment_method')

        # Deleting field 'Trainer.payment_info'
        db.delete_column(u'base_trainer', 'payment_info')
