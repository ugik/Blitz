...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exercise.description'
        db.alter_column(u'workouts_exercise', 'description', self.gf('django.db.models.fields.CharField')(max_length=400))

        # Changing field 'Workout.description'
        db.alter_column(u'workouts_workout', 'description', self.gf('django.db.models.fields.CharField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'Exercise.description'
        db.alter_column(u'workouts_exercise', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Workout.description'
        db.alter_column(u'workouts_workout', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
