...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'workouts_exercise', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)

        # Adding field 'Workout.description'
        db.add_column(u'workouts_workout', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'workouts_exercise', 'description')

        # Deleting field 'Workout.description'
        db.delete_column(u'workouts_workout', 'description')
